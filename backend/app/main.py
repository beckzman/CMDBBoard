...
from app.api.routes import auth_routes, ci_routes, dashboard_routes, import_routes, export_routes, health_routes, domain_routes, user_routes, relationship_routes, cost_routes
